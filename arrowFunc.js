...
themeSong = () => {
  ...
  // Example 2
  // Parentheses "()" can be used in an arrow function to return a value without using the RETURN keyword (NOTE: Semicolon at the of the line is NOT to be used in this case)
  boat = () => (
    `The SS Minnow`
  )
  ...
  crew = () => `Gilligan, Skipper, Mr. Howell, Mrs. Howell, Ginger, The Professor, Mary Ann.`;
  const names = crew();
  console.log(names);
