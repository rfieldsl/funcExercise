...
const friends = [
  ...
  // Creates a new array and set the the value of that new array to the "firstAndLast" variable
  ...
  // Example 2
  // Using an anonymous arrow function as the arugment for the map method
  ...
  // Adds the 4 & 5 array value to the new array that is created
